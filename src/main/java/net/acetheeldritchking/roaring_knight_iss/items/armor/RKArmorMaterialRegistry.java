...
public class RKArmorMaterialRegistry {
    private static final DeferredRegister<ArmorMaterial> ARMOR_MATERIALS = DeferredRegister.create(Registries.ARMOR_MATERIAL, TheRoaringSpellbooks.MOD_ID);

    // Roaring Harbinger
    public static DeferredHolder<ArmorMaterial, ArmorMaterial> ROARING_HARBINGER = register("roaring_harbinger_armor",
            warlockArmorMap(),
            25,
    ...
    {
        List<ArmorMaterial.Layer> list = List.of(new ArmorMaterial.Layer(TheRoaringSpellbooks.id(name)));
